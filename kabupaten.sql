...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2022 at 03:58 PM
...
CREATE TABLE `kabupaten` (
  `id` int(10) NOT NULL,
  `nmKabupaten` varchar(200) NOT NULL,
...
INSERT INTO `kabupaten` (`id`, `nmKabupaten`, `idProvinsi`) VALUES
...
--
ALTER TABLE `kabupaten`
  ADD CONSTRAINT `prov` FOREIGN KEY (`idProvinsi`) REFERENCES `provinsi` (`id`) ON UPDATE CASCADE;
COMMIT;
